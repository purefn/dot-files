...
let
  ...
  packageOverrides = self: super: {
    ...
    cfscrape = super.buildPythonPackage rec {
      pname = "cfscrape";
      version = "1.9.5";

      src = super.fetchPypi {
        inherit pname version;
        sha256 = "1wa6a7a6cbpna5pa566fs7zfns1y84crpk6q9b7q4vhfbnamk4fb";
      };
...
buildPythonApplication rec {
  ...
  propagatedBuildInputs = [
    ...
    cfscrape # for cfscrape, needed for torrentleech
    rarfile  # for decompress
  ...
  # for cfscrape and decompr
  postInstall = ''
    wrapProgram "$out/bin/flexget" \
